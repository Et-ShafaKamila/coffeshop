                                ...
                                <tfoot>
                                    {{-- <tr><td colspan="2"></td> --}}
                                        <tr>
                                            ...
                                            <td class="text-center">Rp.<label id="total" class="total"> 0</label></td>
                                        </tr>
                                        {{-- <td align="right">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-11">
                        <div class="form-group">
                            ...
                            <input type="number" name="kode_pesanan" id="kode_pesanan" class="form-control @error('kode_pesanan') is-invalid @enderror" value="{{ old('kode_pesanan', $kodePesanan) }}" readonly>
                            @error('kode_pesanan')
