      ...
      <div class="sb-sidenav-menu">
          <div class="nav">
            @if (auth()->user() != null)
              ...
              <a class="nav-link {{ Request::segment(2) == 'daftar-menu' ? 'active' : '' }}" href="{{ route('daftar-menu.index') }}">
                <div class="sb-nav-link-icon"><i class="fas fa-coffee"></i></div>
                Daftar Menu
              </a>
              {{-- <a class="nav-link {{ Request::segment(2) == 'meja' ? 'active' : '' }}" href="{{ route('meja.index') }}">
              ...
              @endif
              @if (auth()->user()->role == 'Owner')
              <a class="nav-link {{ Request::segment(2) == 'keuangan' ? 'active' : '' }} collapsed" href="#" data-toggle="collapse" data-target="#collapseLayouts" aria-expanded="false" aria-controls="collapseLayouts">
